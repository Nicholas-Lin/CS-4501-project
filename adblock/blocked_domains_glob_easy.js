var blocked_domains_glob_easy = [
    ...
    '*://*.codezap.com/*',
    '*://*.coedmediagroup.com/*',
    '*://*.coefficientforeverhandshake.com/*',
    '*://*.coenobeullucu.com/*',
    '*://*.coeqagujkay.com/*',
    '*://*.coexploitates.xyz/*',
    ...
    '*://*.headquartercloudlessselfservice.com/*',
    ...
    '*://*.leonodikeu9sj10.com/*',
    '*://*.leontius-eli.com/*',
    '*://*.leopardaddictedenthusiastic.com/*',
    '*://*.leoyard.com/*',
    '*://*.lepinsar.com/*',
    '*://*.lepsogoso.com/*',
    '*://*.lesbianoyster.com/*',
    ...
    '*://*.secureeavesdroppingdisguised.com/*',
    '*://*.securegate.xyz/*',
    '*://*.securegate9.com/*',
    '*://*.securely-send.com/*',
    '*://*.securemoney.ru/*',
    ...
    '*://*.soshoord.com/*',
    '*://*.sotchoft.net/*',
    '*://*.soundingexpulsioninspector.com/*',
    ...
    '*://*.utpvfpoar.com/*',
    '*://*.utq55kl9vyqv.com/*',
    '*://*.utteredhandicappedsomebody.com/*',
    '*://*.utteroccupied.com/*',
    '*://*.utxdtismojqk.xyz/*',
    '*://*.uuaajohul.com/*',
    '*://*.uubforbdc2om.com/*',
